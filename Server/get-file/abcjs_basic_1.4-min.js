...
ABCJS.write.StaffGroupElement.prototype.layout = function(g, o, a) {
    this.spacingunits = 0;
    this.minspace = 1000;
    var l = o.paddingleft;
    var b = 0;
    for (var e = 0; e < this.voices.length; e++) {
        if (this.voices[e].header) {
            var p = o.paper.text(100, -10, this.voices[e].header).attr({
                "font-size": 12,
                "font-family": "serif"
            });
            b = Math.max(b, p.getBBox().width);
            p.remove()
        }
    }
    l = l + b * 1.1;
    ...
    for (e = 0; e < this.voices.length; e++) {
        if (this.voices[e].nextx > l) {
            l = this.voices[e].nextx;
            k = this.voices[e].spacingunits
        }
    }
    this.spacingunits += k;
    this.w = l;
